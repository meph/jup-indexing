module.exports = class Data1719739050464 {
    name = 'Data1719739050464'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "sol_trades" ("id" character varying NOT NULL, "bucket" integer NOT NULL, "trader" character varying(50), "mint" character varying(50), "timestamp" TIMESTAMP WITH TIME ZONE, "token_delta" numeric, "sol_delta" numeric, CONSTRAINT "PK_b64ed7990fc7273480da934580c" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "token_trades" ("id" character varying NOT NULL, "signature" character varying(100) NOT NULL, "bucket" integer NOT NULL, "trader" character varying(50), "timestamp" TIMESTAMP, "mint_spent" character varying(50), "amount_spent" double precision, "mint_got" character varying(50), "amount_got" double precision, CONSTRAINT "PK_a4a8440f4331dbff321ba4ade46" PRIMARY KEY ("id"))`)
